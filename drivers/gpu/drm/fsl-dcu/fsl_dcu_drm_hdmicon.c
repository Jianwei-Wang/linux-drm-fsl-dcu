...
static void fsl_dcu_drm_hdmienc_dpms(struct drm_encoder *encoder, int mode)
{
}

static void fsl_dcu_drm_hdmienc_mode_prepare(struct drm_encoder *encoder)
{
}
...
static void fsl_dcu_drm_hdmienc_mode_commit(struct drm_encoder *encoder)
{
}
...
static const struct drm_encoder_helper_funcs encoder_helper_funcs = {
	.dpms = fsl_dcu_drm_hdmienc_dpms,
	.prepare = fsl_dcu_drm_hdmienc_mode_prepare,
	.commit = fsl_dcu_drm_hdmienc_mode_commit,
...
{
	struct drm_device *dev = fsl_dev->ddev; 
	struct fsl_dcu_drm_hdmicon *hdmicon;
